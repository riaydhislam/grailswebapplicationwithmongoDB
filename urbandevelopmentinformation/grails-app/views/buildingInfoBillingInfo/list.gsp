...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'buildingInfoBillingInfo', default: 'buildingInfoBillingInfo')}" />
...
<g:render template="buildingInfoBillingSearchForm"></g:render> 
...
<div id="list-buildingInfoBillingInfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="biBuId" title="${message(code:'buId.label')}" />
				...
				<tbody>
				<g:each in="${buildingInfoBillingInfoList}" status="i" var="buildingInfoBillingInfoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					    ...
					    <td>${fieldValue(bean: buildingInfoBillingInfoInstance, field: "biBuId")}</td>
						...
						<td>${fieldValue(bean: buildingInfoBillingInfoInstance, field: "biReferenceNumber")}</td>
			...
			<div class="pagination">
				<g:paginate total="${buildingInfoBillingInfoListTotal?: 0}" />
			</div>
		</div>
	</body>
</html>
