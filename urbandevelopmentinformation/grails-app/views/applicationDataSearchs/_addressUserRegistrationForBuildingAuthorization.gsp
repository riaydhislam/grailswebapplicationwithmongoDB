...
<td>
 ...
 <g:link controller="buildingInfoAuthorizationInfo" action="create" params="${[auAddressId: nlistTable.adId,
	auName:nlistTable.adFirstName +" "+nlistTable.adMiddleName +" "+nlistTable.adLastName,
	auNumber:nlistTable.adJobProvider]}">
