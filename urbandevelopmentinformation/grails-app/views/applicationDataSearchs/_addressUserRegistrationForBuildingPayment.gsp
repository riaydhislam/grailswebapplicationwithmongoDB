...
<td>
 ...
 <g:link controller="buildingInfoPaymentInfo" action="create" params="${[paCreaterAddressId: nlistTable.adId,
	paCreaterName:nlistTable.adFirstName +" "+nlistTable.adMiddleName +" "+nlistTable.adLastName,
	pyCreaterAuthority:nlistTable.adJobProvider]}">
