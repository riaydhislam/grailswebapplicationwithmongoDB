...
<td>
 ...
 <g:link controller="userRegistration" action="create" params="${[userAddressId: nlistTable.adId,
	 userRegistrationFName:nlistTable.adFirstName,userRegistrationMName: nlistTable.adMiddleName,userRegistrationLName: nlistTable.adLastName,
	userRegistrationfullName:nlistTable.adFirstName +" "+nlistTable.adMiddleName +" "+nlistTable.adLastName,
	userRegistrationId:nlistTable.adNationalIdNumber]}">
