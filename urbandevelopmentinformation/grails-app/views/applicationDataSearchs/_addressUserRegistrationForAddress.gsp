...
<td>
 ...
 <g:link controller="addressInfo" action="create" params="${[adId: nlistTable.adId,
	adFirstName:nlistTable.adFirstName,adMiddleName: nlistTable.adMiddleName,adLastName: nlistTable.adLastName ]}">
